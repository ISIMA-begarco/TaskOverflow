...
<html>
    ...
    <body>
        ...
        <div id="show-administrator" class="content scaffold-show" role="main">
            ...
            <f:display bean="administrator" />
            <g:form resource="${this.administrator}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.administrator}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
