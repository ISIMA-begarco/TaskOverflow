...
<html>
    ...
    <body>
        ...
        <div id="show-stats" class="content scaffold-show" role="main">
            ...
            <f:display bean="stats" />
            <g:form resource="${this.stats}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.stats}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
