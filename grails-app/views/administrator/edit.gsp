...
<html>
    ...
    <body>
        ...
        <div id="edit-administrator" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.administrator}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.administrator}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.administrator}" method="PUT">
                <g:hiddenField name="version" value="${this.administrator?.version}" />
                <fieldset class="form">
                    <f:all bean="administrator"/>
                </fieldset>
